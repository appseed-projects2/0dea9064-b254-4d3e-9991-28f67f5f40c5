# [Django Flexy Lite](https://django-flexy-bootstrap.appseed-srv1.com)
...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-23 11:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0dea9064-b254-4d3e-9991-28f67f5f40c5.git
$ cd 0dea9064-b254-4d3e-9991-28f67f5f40c5
```
